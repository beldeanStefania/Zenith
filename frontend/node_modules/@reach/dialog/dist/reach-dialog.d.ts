 ...
 */
declare function DialogWrapper({ isOpen, children, ...props }: DialogWrapperProps): JSX.Element;
declare namespace DialogWrapper {
 ...
 */
declare const DialogInner: Polymorphic.ForwardRefComponent<"div", DialogOverlayProps>;
/**
 * DialogOverlay
 *
...
export { Dialog, DialogContent, DialogContentProps, DialogInner, DialogOverlayProps as DialogInnerProps, DialogOverlay, DialogOverlayProps, DialogProps, DialogWrapper as unstable_DialogWrapper, DialogWrapperProps as unstable_DialogWrapperProps };
